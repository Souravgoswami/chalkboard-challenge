...
EOF
	...
	details_raw = <<EOF
					 VERY LOW: (less than 100) You have to improve yourself.
 					LOW: (100 to 350) You need to make some improvements.
 					AVERAGE: (350 to 650) Your brain's performance is normal.
 					GOOD: (650 to 1000) Your brain works very fast.
 					EXCELLENT: (more than 1000) Your brain is highly flexible.
EOF
